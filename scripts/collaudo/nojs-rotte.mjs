...
const out = []
for (const [nome, url] of [['A','http://localhost:3001/'],['B','http://localhost:3001/opzione-b'],['servizio','http://localhost:3001/servizi/strutture'],['progetti','http://localhost:3001/progetti'],['contatti','http://localhost:3001/contatti']]) {
